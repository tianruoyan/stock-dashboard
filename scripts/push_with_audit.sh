...
git add data/quality-report.json data/decision-feed.json data/data-trust.json data/monitoring-coverage.json data/section-health.json data/smoke-report.json data/runtime-smoke-report.json >/dev/null 2>&1 || true
