...
stage_paths=(.gitignore data config index.html style.css app.js server.py RULES.md VERSION.md scripts settings.html settings.js rules.html topics THS_WATCHLIST_SYNC.md)
existing_paths=()
